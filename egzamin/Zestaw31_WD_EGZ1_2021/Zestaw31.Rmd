---
title: "Egzamin (pierwszy termin) - Wizualizacja danych - Zestaw 31"
lang: pl
output:
...
Zad.1. Odwzoruj wykres znajdujący się w pliku o nazwie w31.png. Odcienie kolorów mogą się różnić, jednak główne barwy muszą być zachowane.
Zapisz wykres w formacie pdf za pomocą kodu. 

Zad.2. W jednym pliku wykonaj poniższe czynności:

* załaduj dane z pliku ceny31.xlsx jako ramkę danych (Data Frame),
...
* załaduj dane z pliku cechy31.csv,
* podziel wartości obu cech na koszyki od 100 do 200 z krokiem 10
